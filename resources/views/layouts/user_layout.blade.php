                        ...
                        <nav class="navbar navbar-expand-lg">
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav mr-auto">
                                    ...
                                    <li ><a href="{{ route('user.temporary.staffing') }}" class="@if(Route::currentRouteName()=='user.temporary.staffing') active @endif">Temporary Staffing </a></li>
                                    <li ><a href="{{ route('user.industry.insights') }}" class="@if(Route::currentRouteName()=='user.industry.insights') active @endif">Industry Insights </a></li>
                                    @if(session()->has('c_email'))
                                    @else
                                        <li ><a href="{{route('user.signUp.company')}}" class="@if(Route::currentRouteName()=='user.signUp.company') active @endif">Create Company Profile </a></li>
                                    @endif--}}
                                               ...
                                               aria-haspopup="true" aria-expanded="false">
                                                ...
                                                @elseif(Session::has('c_email'))
                                                    <img class="company_prof_logo"
                                                         ...
                                                         alt=""> @if (Session::get('c_email.name')!=''){{session()->get('c_email.name')}} @else
                                                        Company @endif
