...
{{--                                        <label>Enter City/State</label>--}}
                                    ...
                                    <li class="search-client search-design-btn del"><button onclick="Fun_client(10)" type="button" class="btn btn-primary pull-left">Search</button><button type="button" data-toggle="tooltip"  title="Advanced Search" class="btn btn-primary pull-left mega-search" style="padding: 5px 10px; margin-left: 5px;"><i style="font-size: 30px;" class="pe-7s-config"></i></button></li>
                                    <li class="search-candidate search-design-btn del" style="display: none;"><button onclick="Fun_candidate(10)" type="button" class="btn btn-primary pull-left">Search</button><button type="button" data-toggle="tooltip"  title="Advanced Search" class="btn btn-primary pull-left mega-search" style="padding: 5px 10px; margin-left: 5px;"><i style="font-size: 30px;" class="pe-7s-config"></i></button></li>
                                    <li class="search-job search-design-btn del" style="display: none;"><button onclick="jobsFun(10)" type="button" class="btn btn-primary pull-left">Search</button><button type="button" data-toggle="tooltip"  title="Advanced Search" class="btn btn-primary pull-left mega-search" style="padding: 5px 10px; margin-left: 5px;"><i style="font-size: 30px;" class="pe-7s-config"></i></button></li>
{{--                                </ul>--}}
{{--                                <div class="motivz-job-search">--}}
{{--                                    <ul id="client-search-perent">--}}
                                        <li class="remove-li client-search-perent">
                                            <input id="client-jobTitle" type="text" class="tags_3 form-control" placeholder="Job Title">
                                        </li>
                                        ...
                                        <li class="remove-li client-search-perent"><input class="btn btn-primary" onclick="Fun_client(10)" type="button" value="Search"></li>
{{--                                    </ul>--}}

{{--                                    <ul style="display: none" id="candidate-search-perent">--}}
                                        <li class="remove-li candidate-search-perent">
                                            <input id="candidate-job-title" type="text" class="tags_4 form-control" placeholder="Job Title">
                                        </li>
                                    ...
                                    <li class="remove-li candidate-search-perent">
                                        ...
                                        <li class="remove-li candidate-search-perent"><input class="btn btn-primary" onclick="Fun_candidate(10)" type="button" value="Search"></li>
{{--                                    </ul>--}}
...
{{--                                    <ul style="display: none;" id="job-search-perent">--}}
                                        ...
                                        <li class="remove-li job-search-perent">
                                            <select id="selected-options-main-search" name="" class="form-control second-select multiselect-dropdown">
                                                <option value=""></option>
                                        ...
                                        <li class="remove-li job-search-perent"><input class="btn btn-primary" onclick="jobsFun(10)" type="button" value="Search"></li>
                                    </ul>
                ...
                <div class="col-md-12">
                    <div class="card mb-3">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="card-header-tab card-header">
                                    <div id="module-name" class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-users mr-3 text-muted opacity-6" style="font-size: 35px;"> </i>Clients</div>
                                </div>
                                <div class="card-body candidate-scroll">
                                    <div class="table-responsive">
                                        <table id="htmlShow" style="width: 100%;" class="table table-hover table-striped table-bordered table-cursor candidate-list">
                            ...
                            <div class="col-md-7">
                                <div class="card-header-tab card-header">
                                    <div id="module-detail" class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-notebook mr-3 text-muted opacity-6" style="font-size: 35px;"> </i>Client Details</div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
...
function showDetails(id){
    ...
    $.ajax({
        ...
        html1=' <a class="tag" href="{{url("admin/client/edit/")}}/'+myJSON[0]['id']+'">Edit</a>' +
            '@can('delete', App\Client::class)<a dataId='+myJSON[0]['id']+' class="tag del-swal" href="{{url("admin/client/delete/")}}/'+myJSON[0]['id']+'">Delete</a>@endcan' +
            ''+buttonRecruiter+'';
        // };
...
$(document).on('click', '#addClientpipe', function() {
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    url: "{{route('client.removePipline')}}",
                    type: 'post',
...
function showDetails1(id){
    ...
    $.ajax({
        ...
        {
            skillData += '<small class="borders"><img src="{{ asset('public/assets/images/checkicon.png') }}" alt="">'+skills[a]+'</small>' ;
        }
        ...
        {
            intr += '<small class="borders"><img src="{{ asset('public/assets/images/checkicon.png') }}" alt="">'+interest[b]+'</small>' ;
        }
        ...
        for(let b=0 ; b<myJSON[0]['resumes'].length; b++)
        {
            ...
            if(exs === 'pdf')
            {
                resume += '<a @can('download', App\Resume::class) target="_blank" href="'+window.location.origin+'/public/files/'+myJSON[0]['resumes'][b]['resume']+'"@endcan @cannot('download', App\Resume::class) href="javascript:void(0)" @endcannot style="font-size: 45px; margin: 0px 10px 0px 0px;" data-toggle="tooltip" title="" class="fa fa-file-pdf-o" data-original-title="'+exs+' FILE"></a>'
            }
        ...
        statusTextColor = (myJSON[0]['status']['color'] === '#ffffff') ? "#000000" : "#ffffff" ;
        ...
        html='  <tr><th>Date Logged:</th><td>'+job_date_1+' </td></tr>' +
            ...
            '<tr><th>Status:</th><td><img width="50px" height="50px" src="'+window.location.origin+'/status_icons/'+myJSON[0]['status']['status_icon']+'" data-id="'+myJSON[0]['status']['id']+'" id="candidate-id-'+myJSON[0]['id']+'"></td></tr>' +
