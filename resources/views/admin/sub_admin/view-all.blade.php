...
@section('content')
    ...
    <div class="app-main__inner">
        <div class="card-header-tab card-header">
            <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-users mr-3 text-muted opacity-6" style="font-size: 35px; "> </i>Employee Database</div>
        </div>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <ul class="search-form">
                                <li>
                                    <select  id="search_subadmin" name="" class="form-control second-select multiselect-dropdown">


                                    </select>
                                </li>
                                <li><button style="margin: 0px;" id="search_btn_sub_admin" type="button" class="btn btn-primary pull-left">Search</button></li>
                            </ul>
                            <!-- </form> -->
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="card mb-3">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card-header-tab card-header">
                                    <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-users mr-3 text-muted opacity-6" style="font-size: 35px;"> </i>Employees</div>
                                </div>
                            ...
                            <div class="col-md-8">
                                <div class="card-header-tab card-header">
                                    <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-notebook mr-3 text-muted opacity-6" style="font-size: 35px;"> </i>Employee Information</div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table-detail table table-hover table-striped table-bordered" id="sub_admin_details">
                                        </table>
...
var admin = 0;
    ...
    function showdetails(id)
    {
        ...
        $.ajax({
            ...
            var exs ='';
            var p = '';
            for (let i = 0;i<json['privileges'].length;i++)
            {
                p += '<span>'+json['privileges'][i]['name']+'</span>';
            }
            if(json['resume']!=null)
            {
