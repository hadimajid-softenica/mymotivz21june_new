       ...
       @endif
                <div class="app-main__inner">
                    <div class="card-header-tab card-header">
                        <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-map mr-3 text-muted opacity-6" style="font-size: 35px; color: white !important;"> </i>Recruitment Pipeline</div>
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form action="#">
                                            <ul class="search-form">
                                                <li>
                                                    <input class="form-control" id="com-name" type="text" placeholder="Company Name">
                                                </li>
{{--                                                <li><button id="company-search" type="button" class="btn btn-primary pull-left" onclick="companySearch()">Search</button></li>--}}
                                                <li><button id="company-search" type="button" class="btn btn-primary pull-left" onclick="pageloading(0)">Search</button></li>
                                            </ul>
                                        </form>
                                        <a href="#emptypresentModal" id="present_modal_id" data-toggle="modal" class="btn btn-primary pull-right">Present</a>
                                        <?php
//                                        dd($pipelineClients);
                                        ?>
                                        <a href="{{route('schedule-interview')}}" style="margin: 0px 5px 0px 0px;" class="btn btn-primary pull-right">Schedule Interview</a>
                                    </div>
                                </div>
                            </div>
                        </div>
...
{{--                                                            <th>Location</th>--}}
                                    ...
                                    <div class="col-md-6">
                                        <div class="card mb-3">
                                            <div class="card-header-tab card-header">
                                                <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-note2 mr-3 text-muted opacity-6" style="font-size: 35px;"> </i>Pipeline</div>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table style="width: 100%;" class="table table-hover table-striped table-bordered table-cursor">
    ...
    // alert(note_id);
                    ...
                    function showCandidates(id)
                    {
                        ...
                        $.ajax({
                            ...
                            var newHtml="";
                            // console.log(json);
                            for(let i=0; i<json[0]['candidates'].length; i++)

                            {
                                newHtml = "" ;
                            //
                            for(let j=0;j<json[0]['candidates'][i]['notes'].length;j++)
                            {
                            //
                                var notes=json[0]['candidates'][i]['notes'];
                                    // console.log(notes);
