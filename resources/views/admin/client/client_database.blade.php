...
@section('content')
    ...
    <div class="app-main__inner">
        <div class="card-header-tab card-header">
            <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-users mr-3 text-muted opacity-6" style="font-size: 35px; "> </i>Clients Database</div>
        </div>
...
{{--                                <li>--}}
{{--                                    <input class="form-control" type="text" style="width: 100%;" name="client-name" id="clientName" placeholder="Company Name">--}}
{{--                                </li>--}}
{{--                                <li>--}}
{{--                                    <input class="form-control" type="text" name="client-city" id="clientCity" placeholder="City">--}}
{{--                                </li>--}}
{{--                                <li>--}}
{{--                                    <input class="form-control" type="text" name="client-state" id="clientstate" placeholder="State">--}}
{{--                                </li>--}}
{{--                                <li><button style="margin: 0px;" type="button" onclick="Fun(10)" class="btn btn-primary pull-left">Search</button></li>--}}
{{--                            </ul>--}}
                            <!-- </form> -->
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input class="form-control" type="text" style="width: 100%;" name="client-name" id="clientName" placeholder="Company Name">                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <input class="form-control" type="text" name="client-city" id="clientCity" placeholder="City">
                                ...
                                <div class="col-md-4">
                                    <button style="margin: 0px;" type="button" onclick="Fun(10)" class="btn btn-primary pull-left">Search</button>
                                </div>
                            </div>
                        ...
                        <div class="table-ovrflow">
                            <div class="table-ovrflow-width" style="width: 1300px;">
                                <div class="row">
                                        ...
                                        <div class="card-body candidate-scroll">
                                            <div class="table-responsive">
                                                ...
                                                <table style="width: 100%;" class="table table-hover table-striped table-bordered table-cursor candidate-list">
                                                    <thead>
                                                    <tr><th>Company Name</th><th>POC</th><th>Industry</th><th>#Job Openings</th></tr>
                                                    </thead>
                                                    <tbody id="htmlShow">
                                    ...
                                    <div class="col-md-7">
                                        <div class="card-header-tab card-header">
                                            <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-notebook mr-3 text-muted opacity-6" style="font-size: 35px;"> </i>Client Details</div>
                                        </div>
                                        <div class="card-body">
                                            <div class="table-responsive">
