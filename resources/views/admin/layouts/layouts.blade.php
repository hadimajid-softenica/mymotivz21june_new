                  ...
                  <div class="form-group">
                    <label>Select Client Name</label>
                     ...
                     <?php if(!empty($jobDetail) && count($jobDetail)>0){?>
                       <input type="hidden" name="id" id="form-id-job-pipline-id-field" value="{{$jobDetail[0]->id}}">
                        <?php } ?>
                    <select name="name" value="{{ old('name') }}" required class="multiselect-dropdown form-control" id="client_name">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" name="id" id="form-id-job-pipline-id-field" value="{{$jobDetail[0]->id}}">
                                    <?php } ?>
                                    <select name="name" value="{{ old('name') }}" required class="multiselect-dropdown form-control" id="">
                                        <?php if(!empty($clientss)){?>
                                        @forelse($clientss as $client)
                                            <option value="{{$client->id}}">{{$client->company_name}}</option>
                                        @empty
