...
{{--    to get candidate id --}}
    ...
    <div class="card-header-tab card-header">
        <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-users mr-3 text-muted opacity-6" style="font-size: 35px; color: white !important;"> </i>Candidate Database</div>
    </div>
...
{{--                                <input type="hidden" id="session_exist" value="@if(session()->has('candidate_search_session')) 1 @else 0  @endif">--}}
{{--                                <li>--}}
{{--                                    <input class="form-control" id="candidateName" name="candidate_name" type="text" style="width: 100%;" placeholder="Candidate's Name" value="@if(session()->has('candidate_search_session.name')) {{session()->pull('candidate_search_session.name')}}   @endif">--}}
{{--                                </li>--}}
{{--                                <li>--}}
{{--                                    <input class="form-control" id="candidateCity" name="city" type="text" placeholder="Enter City" value="@if(session()->has('candidate_search_session.city')) {{session()->pull('candidate_search_session.city')}}    @endif">--}}
{{--                                </li>--}}
{{--                                <li>--}}
{{--                                    <input class="form-control" id="candidatestate" name="state" type="text" placeholder="Enter State" value="@if(session()->has('candidate_search_session.state')) {{session()->pull('candidate_search_session.state')}}    @endif">--}}
{{--                                </li>--}}
...
{{--                            </ul>--}}
                            <div class="row">
                                ...
                                <div class="col-md-4 del">
                                    <button onclick="Fun(10)" style="margin: 0px;" type="button" class="btn btn-primary pull-left">Search</button><button type="button" data-toggle="tooltip" id="mega-search" title="Advanced Search" class="btn btn-primary pull-left mega-search" style="padding: 5px 10px; margin-left: 5px; margin-top: 0px;"><i style="font-size: 18px;" class="pe-7s-config"></i></button>
                                </div>
                            </div>
                            <div  class="motivz-job-search can-adv-srch">
                                <ul>
                                    ...
                                    <li>
                                        <input id="Industry" name="Industry" type="text" class="form-control" placeholder="Types of Industry" value="@if(session()->has('candidate_search_session.industry')) {{session()->pull('candidate_search_session.industry')}}    @endif">
                                    </li>
                                    <li>
                                        <input id="Skills" name="Skills" type="text" class="tags_2 tags form-control" placeholder="Skills" value="@if(session()->has('candidate_search_session.skills')) {{session()->pull('candidate_search_session.skills')}}   @endif">
                                    </li>
                                    <li>
                                        <input id="job-title" name="jobTitle" type="text" class="tags_3 form-control" placeholder="Job Title" value="@if(session()->has('candidate_search_session.title')) {{session()->pull('candidate_search_session.title')}}    @endif">
                                    </li>

                                    <li>
                                        <select onchange="" id="selected-options-status" name="" class="form-control second-select multiselect-dropdown">
                                           <option value="0">None</option>
                                            @foreach($statuses as $status)

                                                <option value="{{$status->id}}" @if(session()->has('candidate_search_session.status')) @if(session('candidate_search_session.status')==$status->id) selected  @endif @endif>{{$status->name}}</option>
                                            @endforeach
                                        </select>
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="card-body candidate-scroll">
                                <div class="table-responsive">
                                    ...
                                    <a class="tag " id="bulk_status_btn" data-toggle="modal" href="#bulkstatusModal" style="float: right">Update Status</a>
                                    <a class="tag " id="contact_candidate_btn" data-toggle="modal" href="#contact_candidateModal" style="float: right">Contact</a>
