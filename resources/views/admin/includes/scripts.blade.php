{{--edit privileges--}}
<div class="modal fade show" id="privilegeModal" tabindex="-1" role="dialog" aria-labelledby="privilegeModalLabel" aria-modal="true" style="display: none; padding-right: 17px;">
            ...
            <div class="modal-body">
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-12"><button id="update-privilege" type="button" data-dismiss="modal" class="btn btn-primary pull-left">Save</button>
...
<div class="modal fade show" id="bulkstatusModal"  role="dialog" aria-labelledby="bulkstatusModalLabel" aria-modal="true" style="display: none; padding-right: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <select id="bulk_status_list" name="bulk_status" class="multiselect-dropdown form-control">


                                </select>
                            </div>
                        </div>
                        <div class="col-md-12"><button id="update-status-bulk_btn"  type="button"  class="btn btn-primary pull-left">Update</button>
                            {{--                           <button style="margin: 0px 0px 0px 5px;" type="button" data-dismiss="modal" data-toggle="modal" data-target="#statusupdateModal" class="btn btn-primary pull-left">Add New Status</button>--}}
                        </div>
                    </div>
                    <div class="clearfix"></div>
...
<div class="modal fade show" id="candidate_sampleModal" tabindex="-1" role="dialog" aria-labelledby="candidate_sampleModalLabel" aria-modal="true" style="display: none; padding-right: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="{{asset('assets/sample_imports')}}/candidate.png" download="Candidate Sample"  class="btn btn-primary pull-left">Download</a>
                            {{--                           <button style="margin: 0px 0px 0px 5px;" type="button" data-dismiss="modal" data-toggle="modal" data-target="#statusupdateModal" class="btn btn-primary pull-left">Add New Status</button>--}}
                        </div>
                    </div>
                    <div class="clearfix"></div>
...
<div class="modal fade show" id="job_sampleModal" tabindex="-1" role="dialog" aria-labelledby="job_sampleModalLabel" aria-modal="true" style="display: none; padding-right: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="{{asset('assets/sample_imports')}}/job.png" download="Job Sample"  class="btn btn-primary pull-left">Download</a>
                            {{--                           <button style="margin: 0px 0px 0px 5px;" type="button" data-dismiss="modal" data-toggle="modal" data-target="#statusupdateModal" class="btn btn-primary pull-left">Add New Status</button>--}}
                        </div>
                    </div>
                    <div class="clearfix"></div>
...
<div class="modal fade show" id="client_sampleModal" tabindex="-1" role="dialog" aria-labelledby="client_sampleModalLabel" aria-modal="true" style="display: none; padding-right: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form>
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="{{asset('assets/sample_imports')}}/client.png" download="Client Sample"  class="btn btn-primary pull-left">Download</a>
                            {{--                           <button style="margin: 0px 0px 0px 5px;" type="button" data-dismiss="modal" data-toggle="modal" data-target="#statusupdateModal" class="btn btn-primary pull-left">Add New Status</button>--}}
                        </div>
                    </div>
                    <div class="clearfix"></div>
                ...
                <form action="javascript:void(0)" id="edit_todo_form" style="margin: 0px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Actions</label>
                                <select name="todo_action" id="edit_todo_action_list" class="multiselect-dropdown form-control">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="edit_todo_date" placeholder="--/--/----" name="todo_date" class="form-control">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="todo_task" id="edit_todo_task" class="form-control" placeholder=""></textarea>
                            </div>
                        </div>
                    </div>
                    <button type="button" id="todo_edit_submit" class="btn btn-primary">Edit</button>
                    <button data-id="" type="button" id="todo_delete_submit" class="delete_todo btn btn-primary pull-right">Delete</button>
                ...
                <form action="javascript:void(0)" id="add_todo_form" style="margin: 0px;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Actions</label>
                                <select name="todo_action" id="todo_action_list" class="multiselect-dropdown form-control">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="todo_date" placeholder="--/--/----" name="todo_date" class="form-control datepicker">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Task Details</label>
                                <textarea name="todo_task" id="todo_task" class="form-control" placeholder=""></textarea>
                            </div>
                        </div>
                    </div>
...
{{--update action model--}}
<div class="modal fade show" id="updateActionModel" tabindex="-1" role="dialog" aria-labelledby="ActionupdateModalLabel" style="display: none;" aria-modal="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input id="action_update_color" data-testing-action="1" type="color" class="form-control" placeholder="">
                            </div>
                        </div>
                        <div class="col-md-12"><button id="model-action-update" type="button" data-dismiss="modal" class="btn btn-primary pull-left">Save</button> </div>
                    </div>
                    <div class="clearfix"></div>
                </form>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="placement_start_date" placeholder="--/--/----" name="placement_start_date"  data-toggle="datepicker" class="form-control">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Company</label>
                                <select onchange="job_change_company()" class="multiselect-dropdown form-control" name="hire_company_name" id="hire_company_name" disabled="disabled">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="multiselect-dropdown form-control" name="hired_candidate" id="hired_candidate" disabled>
                                    <option value="" style="display: none;"></option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="multiselect-dropdown form-control" name="job_position" id="job_position" disabled>
                                    <option value="" style="display: none;"></option>
                                </select>
                            </div>
                        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" id="close_edit_placement_btn" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="text" id="edit_placement_start_date" placeholder="--/--/----" name="placement_start_date" class="form-control">
                                {{--                                <input type="text" class="form-control">--}}
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Company</label>
                                <select  class="multiselect-dropdown form-control" name="hire_company_name" id="edit_hire_company_name" disabled="disabled">
                                    <option value="" style="display: none;"></option>
                                    @if(isset($pipelineClients))
                                        @foreach($pipelineClients as $pipelineClient)
                                            <option class="client-list-op" value="{{$pipelineClient['id']}}">{{$pipelineClient['company_name']}}</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Candidate</label>
                                <select class="multiselect-dropdown form-control" name="hired_candidate" id="edit_hired_candidate" disabled="disabled">
                                    <option value="" style="display: none;"></option>
                                    @if(isset($jobCandidates))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Position</label>
                                <select class="multiselect-dropdown form-control" name="job_position" id="edit_job_position" disabled="disabled">
                                    <option value="" style="display: none;"></option>
                                </select>
                            </div>
                        </div>
...
<div class="modal fade" id="editcontractformModal"  role="dialog" aria-labelledby="editcontractformModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editcontractformModalLabel">Edit Contract</h5>
                <button type="button" id="edit_contract_close_btn" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('contractedit')}}" method="post" id="edit_contract_form" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        {{--                        <div class="col-md-6">--}}
                        {{--                            <div class="form-group">--}}
                        {{--                                <label>Business Legal Name (include LLC or Inc. if available)</label>--}}
                        {{--                                <input type="text" name="edit_business_name" id="edit_business_name" class="form-control" placeholder="">--}}
                        {{--                                @error('business_name')--}}
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_full_name" id="edit_full_name" class="form-control" placeholder="" disabled>
                                @error('full_name')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_job_title" id="edit_job_title" class="form-control" placeholder="" disabled>
                                @error('job_title')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_phone_no" id="edit_phone_no"  class="form-control" placeholder="" disabled>
                                @error('phone_no')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="email" name="edit_email_address" id="edit_email_address" class="form-control" placeholder=""disabled>
                                @error('email_address')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="industry" id="edit_industry_contract" class="tags form-control" placeholder="" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Business Website</label>
                                <input type="text" name="edit_business_web" id="edit_business_web" class="form-control" placeholder="" disabled>
                                @error('business_web')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_business_address" id="edit_business_address" class="form-control" placeholder="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_business_number"  id="edit_business_number" class="form-control" placeholder="">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_positions" id="edit_positions" class="form-control" placeholder="">
                                @error('positions')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="edit_opening" id="edit_opening" class="form-control" placeholder="">
                                @error('opening')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="edit_quoted_fee" id="edit_quoted_fee" class="form-control" placeholder="">
                                @error('quoted_fee')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Upload Contract  &nbsp;&nbsp;&nbsp;<small >Only PDF,Docx and Doc</small></label>
                                ...
                                <label id="file-upload-demo-error" class="error" for="file-error2" style="display: none">Only PDF DOC and Docx files are allowed</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="pdf-remove-img">
                                <ul>
                                    ...
                                    <li ><figure id="edit-contract-file"></figure></li>
                                </ul>
                            </div>
                        </div>
                        {{--                        <div class="col-md-6">--}}
...
<div class="modal fade" id="contractformModal"  role="dialog" aria-labelledby="contractformModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select onchange="autofill_contract()" id="contract_clients" name="client_id" class="contract_clients multiselect-dropdown form-control">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Full Name</label>
                                <input type="text" name="full_name" id="full_name_contract" class="form-control" placeholder="" disabled>
                                @error('full_name')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Job Title</label>
                                <input type="text" name="job_title" id="job_title_contract" class="form-control" placeholder="" disabled>
                                @error('job_title')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="phone_no" id="phone_no_contract" class="form-control"   placeholder="" disabled>
                                @error('phone_no')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Email Address</label>
                                <input type="email" name="email_address" id="email_address_contract" class="form-control" placeholder="" disabled>
                                @error('email_address')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Industry</label>
                                <input type="text" name="industry" id="industry_contract" class="tags form-control" placeholder="" disabled>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Business Website</label>
                                <input type="text" name="business_web" id="business_web_contract" class="form-control" placeholder="" disabled>
                                @error('business_web')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Quoted Fee</label>
                                <input type="text" name="quoted_fee" id="quoted_fee" class="form-control" placeholder="">
                                @error('quoted_fee')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <label id="file-upload-demo-error" class="error" for="file-error1" style="display: none">Only PDF DOC and Docx files are allowed</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<div class="modal fade" id="contact_candidateModal" role="dialog" aria-labelledby="econtact_candidateModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="contact_candidateModalLabel">Contact</h5>
                <button type="button" class="close" id="contact_candidatemodal-close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('send_email')}}" method="post" style="margin: 0px;" id="contact_candidate_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Message</label>
                                <textarea placeholder="Type here" id="contact_message" name="message" class="form-control"></textarea>
                                @error('message')
                                <div class="error">{{ $message }}</div>
                                @enderror
                            </div>
...
{{--<!-- Modal -->--}}
<div class="modal fade" id="interview_detail_modal" tabindex="-1" role="dialog" aria-labelledby="interview_detail_modalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <table style="width: 100%;" class="table table-detail table-hover table-striped table-bordered table-cursor">
                        <tbody>
                        <tr><th>Company Name:</th><td id="d_company_name"></td></tr>
                        <tr><th>Job Title:</th><td id="d_job_name"></td></tr>
                        <tr><th>Candidate Name:</th><td id="d_candidate_name"></td></tr>
                        <tr><th>Status:</th><td ><img width="50px" height="50px" src="" id="d_status"></td></tr>
                        <tr><th>Location:</th><td id="d_location"></td></tr>
                        <tr><th>Date:</th><td id="d_date"></td></tr>
                        <tr><th>From:</th><td id="d_start_date"></td></tr>
                        <tr><th>To:</th><td id="d_end_date"></td></tr>
                        <tr><th>Time Zone:</th><td id="d_time_zone"></td></tr>
                        <tr><th>Subject:</th><td id="d_subject"></td></tr>
                        <tr><th>Receiver's Email Address:</th><td id="d_emails"></td></tr>
                        <tr><th>Message:</th><td id="d_message"></td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
...
<div class="modal fade show" id="pipelinestatusModal"  role="dialog" aria-labelledby="pipelinestatusModalLabel" aria-modal="true" style="display: none; padding-right: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="pipelinestatusModalLabel">Update Status</h5>
                <button type="button" class="close" id="pipeline_status_cls_btn" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <select id="pipeline_status_list" name="pipeline_status" class="multiselect-dropdown form-control">


                                </select>
                            </div>
                        </div>
                        <div class="col-md-12"><button id="update-status-pipeline_btn" data-dismiss="modal" type="button"  class="btn btn-primary pull-left">Update</button>
                            {{--                           <button style="margin: 0px 0px 0px 5px;" type="button" data-dismiss="modal" data-toggle="modal" data-target="#statusupdateModal" class="btn btn-primary pull-left">Add New Status</button>--}}
                        </div>
                    </div>
                    <div class="clearfix"></div>
...
<div class="modal fade show" id="interviewstatusModal"  role="dialog" aria-labelledby="interviewstatusModalLabel" aria-modal="true" style="display: none; padding-right: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="statusModalLabel">Update Status</h5>
                <button type="button" class="close" id="interview_status_cls_btn" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <select id="interview_status_list" name="interview_status" class="multiselect-dropdown form-control">


                                </select>
                            </div>
                        </div>
                        <div class="col-md-12"><button id="update-status-interview_btn" data-dismiss="modal" type="button"  class="btn btn-primary pull-left">Update</button>
                            {{--                           <button style="margin: 0px 0px 0px 5px;" type="button" data-dismiss="modal" data-toggle="modal" data-target="#statusupdateModal" class="btn btn-primary pull-left">Add New Status</button>--}}
                        </div>
                    </div>
                    <div class="clearfix"></div>
...
<div class="modal fade" id="dashboard_candidate_notes_modal" tabindex="-1" role="dialog" aria-labelledby="dashboard_candidate_notesLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="dashboard_candidate_notesLabel">Add Notes</h5>
                <button type="button" id="candidate_add_note_close_btn" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea id="pipeline_new_note" class="form-control note-val" name="note" placeholder="" required ></textarea>
...
{{--New Status pop up--}}
<div class="modal fade" id="new_status_Modal" tabindex="-1" role="dialog" aria-labelledby="new_status_ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="status_name_modal" name="status_name" type="text" class="form-control" placeholder="" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input id="status_color" name="color" type="color" class="form-control" placeholder="" required>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="editNotecandidate" tabindex="-1" role="dialog" aria-labelledby="editNotecandidateLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editNotecandidateLabel">Edit Note</h5>
                <button type="button" id="edit_note_candidate_cls_btn" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label>Type Here</label>
                    <textarea id="node-edit-candidate" class="form-control" name="note" placeholder="" required></textarea>
                </div>
                                ...
                                <select id="status-updated-slc" name="status_updated_slc" class="form-control ">
                                    ...
                                    @if(isset($statuses))
                                        @foreach($statuses as $status)
                                            <option image="{{asset('status_icons')}}/{{$status['status_icon']}}" value="{{$status['id']}}">{{$status['name']}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            </div>
...
<div class="modal fade show" id="updateStatusModel" tabindex="-1" role="dialog" aria-labelledby="statusupdateModalLabel" style="display: none;" aria-modal="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{route('status.update.main')}}" enctype="multipart/form-data" id="update_status_form">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
...
{{--                            </div>--}}
                        ...
                        <div class="col-md-12"><button id="model-stts-update" type="button"  class="btn btn-primary pull-left">Save</button> </div>
                    </div>
                    <div class="clearfix"></div>
                </form>
            </div>
...
<div class="modal fade" id="emptypresentModal" role="dialog" aria-labelledby="emptypresentModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select onchange="emptyfunctionSet()" id="company_name_empty_present" class="multiselect-dropdown client-list-check form-control" name="company_name">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Job Title</label>
                                <select class="multiselect-dropdown form-control" name="job_title" id="job-list-empty-present">
                                    <option value="" style="display: none;"></option>
                                </select>
                                @error('job_title')
                                <div class="error">{{ $message }}</div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="multiselect-dropdown form-control " id="candidate-id-empty-present" multiple name="candidates[]">
                                    <option value="" style="display: none;"></option>
                                    @if(isset($jobCandidates))
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input type="hidden" id="hidden_emails" name="hidden_emails" class="form-control " placeholder="">
                ...
                <form action="{{route('send_cv')}}" method="post" style="margin: 0px;" id="present_form">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Company Name</label>
                                <select onchange="functionSet()" id="company_name_present" class="multiselect-dropdown client-list-check form-control" name="company_name">
                                    <option value="" style="display: none">Select Company</option>
                                    @if(isset($pipelineClients))
                                        @foreach($pipelineClients as $pipelineClient)
                                            <option class="client-list-op" value="{{$pipelineClient['id']}}">{{$pipelineClient['company_name']}}</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Job Title</label>
                                <select class="multiselect-dropdown form-control" name="job_title" id="job-list-present">
                                    <option value="" style="display: none;"></option>
                                </select>
                                @error('job_title')
                                <div class="error">{{ $message }}</div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Candidate Name</label>
                                <select class="multiselect-dropdown form-control " id="candidate-id-present" multiple name="candidates[]">
                                    <option value="" style="display: none;"></option>
                                    @if(isset($jobCandidates))
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close"  id="pipelineModal_letest_cls_btn" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <p style="display: none" id="error-job-cand-pipeline" class="error">Please select a job.</p>
                            </div>
                        </div>

                        {{--                        @if (\Route::current()->getName() == 'candidate.otm')--}}
                        {{--                            <div class="col-md-12">--}}
                        {{--                                <div class="form-group">--}}
                        {{--                                    <label>Update-status</label>--}}
                        {{--                                    <select id="select-status-name" class="multiselect-dropdown form-control" name="" id="">--}}
                        {{--                                        @if(isset($stsWithoutOtm) )--}}
                        {{--                                            @foreach($stsWithoutOtm as $stsotm)--}}
                        {{--                                                <option value="{{$stsotm->id}}">{{$stsotm->name}}</option>--}}
                        {{--                                            @endforeach--}}
                        {{--                                        @endif--}}
                        {{--                                    </select>--}}
                        {{--                                </div>--}}
...
{{--update status model--}}
<div class="modal fade show" id="statusModal-client-dashboard"  role="dialog" aria-labelledby="statusModalLabel" aria-modal="true" style="display: none; padding-right: 17px;">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="statusModalLabel">Update Status</h5>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <select id="status-updated-slc-client-dashboard" name="status_updated_slc" class="form-control multiselect-dropdown">
    ...
    $('#add-candidate-pipeline-submit').click(function () {
        ...
        if(job_id === undefined)
        {
            ...
            $.ajax({
                ...
                data: { "_token": "{{ csrf_token() }}" , candidate_id:candidate_id , 'job_id':job_id , 'status_id':status_id},
                ...
                // if(res == "remove from otm")
                // {
                //     $('.add-note[data-id="'+candidate_id+'"]').remove();
                // }

                $('#pipelineModal_letest_cls_btn').click();
                // $('#pipelineModal_letest').hide();
                // $('.modal-backdrop').remove();
...
<script>
    ...
    $(document).on("click", "#view_interview_detail", function (event) {
        ...
        $.ajax({
            ...
            var json = JSON.parse(res) ;
            // console.log(json);
            $('#d_company_name').html(json['data']['clients']['company_name']);
            $('#d_candidate_name').html(json['data']['candidates']['name']);
            $('#d_job_name').html(json['data']['jobs']['jobtitle']);
            $('#d_status').attr('src',window.location.origin+'/status_icons/'+json['data']['status']['status_icon']);
