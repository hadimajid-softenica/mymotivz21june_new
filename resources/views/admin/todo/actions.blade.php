                 ...
                 for (let i=0 ; i<json.length ; i++)
                 {
                                ...
                                index++ ;
                                   ...
                                   actionHtml+= '<td colspan="3" style="background: #fff;cursor: default;padding: 1px;"></td></tr><tr id="stts-row-'+json[i]['id']+'">\n' +
                                       ...
                                       '<td><a data-toggle="modal" data-id="'+json[i]['id']+'" class="tag action-edit" href="#updateActionModel">Edit</a> <a data-id="'+json[i]['id']+'" class="tag action-del" href="javascript:void(0)">Delete</a>\n' +
                                       '</td>\n' +
                                       '</tr>' ;
