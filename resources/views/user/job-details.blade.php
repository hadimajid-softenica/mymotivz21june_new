                    ...
                    <div class="motivz-typo-wrap">
                        <figure class="motivz-jobdetail-list" style="padding:15px 15px 0 15px !important;">
                            <span class="motivz-jobdetail-listthumb"><small
                                        style="background-image: url(' @if(!is_null($job['client']['logo'])) {{asset('user/company_logo/'.$job['client']['logo'])}} @else {{ asset('/user/images/featured-img1.jpg') }} @endif');"></small></span>
                            <figcaption>
                                <h2>{{$job->job_title}}</h2>
                                <span><small class="motivz-jobdetail-type">{{$job['service']}}</small><a
                                            href="{{$job->web_url}}"
                                            target="_blank">{{$job['client']['company_name']}}</a>
                                    @php
