...
@section('content')
    <div class="app-main__inner">
        ...
        <div class="card-header-tab card-header">
            <div class="card-header-title font-size-lg text-capitalize font-weight-normal"><i class="pe-7s-shield mr-3 text-muted opacity-6" style="font-size: 35px; color: #4d9a10 !important;"> </i>Inactive Jobs</div>
        </div>
                ...
                $.ajax({
                    ...
                    for (var i = 0 ; i <myJSON.length; i++) {
                        ...
                        html+= '<li class="col-md-12 li_'+myJSON[i]['id']+'">'+
                            ...
                            '<div class="motivz-joblisting-text">'+
                            '<div class="motivz-list-option">'+
                            '<h2><a href="'+window.location.origin+'/company/active/jobs/view-details/'+myJSON[i]['id']+'">'+myJSON[i]['job_title']+'</a> <span class="expired-color">Expired: '+time_ago+'</span></h2>'+
                            '<ul>'+
