                    ...
                    $.ajax({
                        ...
                        for (var i = 0 ; i <myJSON.length; i++) {
                            ...
                            html+='<li class="col-md-12 li_'+myJSON[i]['id']+'">'+
                                        '<div class="motivz-joblisting-classic-wrap">'+
                                            '<figure><a href=""'+window.location.origin+'/company/active/jobs/view-details/'+myJSON[i]['id']+'""><img src="'+window.location.origin+'/user/company_logo/'+myJSON[i]['client']['logo']+'" alt=""></a></figure>'+
                                            '<div class="motivz-joblisting-text">'+
                                                '<div class="motivz-list-option">'+
                                                ...
                                                '<div class="motivz-job-userlist">'+
                                                    ...
                                                    '<a href="'+window.location.origin+'/company/active/jobs/view-details/'+myJSON[i]['id']+'" class="motivz-option-btn">View Details</a>'+
