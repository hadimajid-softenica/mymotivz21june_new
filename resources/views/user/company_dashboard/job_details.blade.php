                        ...
                        <figure class="motivz-jobdetail-list" style="padding:15px 15px 0 15px !important;">
                            ...
                            <figcaption>
                                ...
                                <span><small class="motivz-jobdetail-type">{{$job->service}}</small><a
                                            ...
                                            class="motivz-jobdetail-postinfo">{{$newDuration}}</small></span>
                                    ...
                                    @if(count($candidates_applied))
                                        @foreach($candidates_applied as $candidate)
                                            @php
                                                ...
                                                $startTime = \Carbon\Carbon::parse( $candidate['created_at'] );
                                                ...
                                                <div class="motivz-joblisting-classic-wrap">
                                                    <figure>
                                                        <a href="{{route('user.candidate-details',[$cand,$jobID])}}"><img
                                                                    src="@if(!empty($candidate['candidate']['prof_image'])){{asset('/uploads/Candidate_Profile_Images/'.$candidate['candidate']['prof_image'])}} @else {{asset('user/images/avatar1.png')}} @endif"
                                                                    alt=""></a></figure>
                                                    <div class="motivz-joblisting-text">
                                                        <div class="motivz-list-option">
                                                            <h2>
                                                                ...
                                                                <span> Apply: {{$duration}}</span></h2>
                                                            <ul>
                                                                @if(!empty($candidate['candidate']['job_title']))
                                                                    <li>
                                                                        <a href="javascript:void(0)">{{$candidate['candidate']['job_title']}}</a>
                                                                    </li>
                                                                @else
                                                                    <li><a href="javascript:void(0)">N/A</a></li>
                                                                @endif
                                                                <li><i class="fa fa-phone"></i> {{$candidate['phone']}}
                                                                </li>
                                                                ...
                                                                @else
                                                                    <li><i class="fa fa-graduation-cap"></i> N/A</li>
                                                                @endif
                                                                <li>
