            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="main-card mb-3 card">
                        ...
                        <div class="card-body">
                            <form id="user-company-profile" method="post" action="{{ route('user.client.profile.submit') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company_name" class="form-control" placeholder=""  value="{{$client->company_name}}">
                                        </div>
                                        @error('company_name')
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="name" value="{{$client->name}}" type="text" class="form-control" placeholder="">
                                        </div>
                                        @error('name')
                                        <label class="text-danger">{{$message}}</label>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input name="phone" id="phone" value="{{$client->phone}}" type="text" class="form-control" placeholder="">
                                        </div>
                                        @error('phone')
                                        <label class="text-danger">{{$message}}</label>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input disabled name="email" value="{{$client->email}}" type="text" class="form-control" placeholder="">
                                        </div>
                                        @error('email')
                                        <label class="text-danger">{{$message}}</label>
                                        @enderror
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Address</label>
                                            <input name="address" id="address" value="{{$client->address}}" type="text" class="form-control" placeholder="">
                                        </div>
                                    </div>
{{--                                    <div class="col-md-4">--}}
{{--                                        <div class="form-group">--}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <input name="complete_address" id="location" type="text" class="form-control" placeholder="" value="{{$client->complete_address}}">
                                            </div>
{{--                                            @error('state')--}}
{{--                                            <label class="text-danger">{{$message}}</label>--}}
{{--                                            @enderror--}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="job_discription">{{$client->job_discription}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div enctype="multipart/form-data">
                                                ...
                                                @if(Session::has('c_email.logo') && $client->logo != '')
                                                    <br>
                                                    <a href="{{ asset('/user/company_logo/') }}/{{Session('c_email.logo')}}"  download class="resume_{{$client->id}}">
                                                        <img style="width: 100px ; height: 100px" src="{{ asset('/user/company_logo/') }}/{{Session('c_email.logo')}}" >
                                                    </a>

                                                    <a href="javascript:void(0)" onclick="resume_del({{$client->id}})" class="icon_{{$client->id}}">
                                        ...
                                        <label id="file-upload-error" style="display: none;" class="error" for="file-upload">Only docx and pdf files are allowed for resume.</label>
                                    </div>
