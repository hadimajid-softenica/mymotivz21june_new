                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="input-group mb-3 div_package_to" @if(empty($Candidate['salary_to'])) style="display: none" @endif>
                                                        ...
                                                        <input name="package_to" type="text" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" placeholder="To" value="{{$Candidate->salary_to}}" >
                                                    </div>
                                                </div>
                                                @error('package_to')
