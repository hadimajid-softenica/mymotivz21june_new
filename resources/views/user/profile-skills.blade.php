                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mm-motivz-jobdetail-content details-tabswrapper">
                            ...
                            <form action="{{route('candidate.save.skills.details')}}" name="profile_form" id="form_profile" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select name="sel_education" id="" class="form-control">
                                                <option style="display: none;" value="">Select your highest level of education</option>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="skills" name="skills" data-role="tagsinput" class="tags_1 tags form-control" placeholder="" value="@if(!is_null($Candidate['skills'])){{$Candidate->skills}}@else{{$default_skills}}@endif">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Add any certificates or licenses that you have achieved</label>
                                            @php $default_certificates = 'CPR , PE ,American Board of Dermatology' @endphp
                                            <input type="hidden" id="temp" value="{{is_null($Candidate['certifications'])}}">
                                            <input name="required_certification" data-role="tagsinput" id="required_certification" type="text" class="tags_1 tags form-control" placeholder="Use comma or enter to separate certification" value="@if(!is_null($Candidate['certifications']) && !empty($Candidate['certifications'])){{$Candidate->certifications}}@else{{$default_certificates}}@endif">
