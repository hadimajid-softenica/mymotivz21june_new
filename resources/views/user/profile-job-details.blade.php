                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="mm-motivz-jobdetail-content details-tabswrapper">
                            ...
                            <form action="{{route('candidate.save.personal.job.details')}}" name="profile_form" id="form_profile" enctype="multipart/form-data" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <select name="sel_experience" id="" class="form-control">
                                                <option style="display: none;" value="">Select your experienced level</option>
                                    ...
                                    <div class="col-md-12">
                                        <br>
                                        <a href="{{route('candidate.view.personal.details')}}"><button type="button" class="form-submit">Back</button></a>
